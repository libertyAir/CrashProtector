...
static const NSString *LACrashSeparatorWithFlag = @">>>>>>>>>>>>>>>>>>>>>>>> LACrashProtector <<<<<<<<<<<<<<<<<<<<<<<<";

@implementation LACrashLog
...
+ (void)la_noteErrorWithException:(NSException *)exception attachedTODO:(NSString *)todo {
    ...
    NSString *logErrorMessage = [NSString stringWithFormat:@"\n\n%@\n\n%@\n%@\n%@\n%@\n%@\n",LACrashSeparatorWithFlag, crashType, errorReason, errorPlace, crashProtector, exception.callStackSymbols];
